...
public class BoxEBox {
	...
	BoxEBox buildBox (int x1, int y1, int x2, int y2) {
		this.x1= x1;
		this.y1 = y1;
		this.x2 = x2;
		this.y2 = y2;
	...
	BoxEBox buildBox(Point topLeft, Point bottomRight) {
		x1 = topLeft.x;
		y1 = topLeft.y;
		x2 = bottomRight.x;
		y2 = bottomRight.y;
	...
	BoxEBox buildBox(Point topLeft, int w, int h) {
		x1 = topLeft.x;
		y1 = topLeft.y;
		x2 = (x1 + w);
		y2 = (y1 + h);
